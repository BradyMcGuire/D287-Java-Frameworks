...
class PartTest {
    ...
    public void minInv() {
        int expVal = 0;
        partIn.setInvMin(expVal);
        assertEquals(expVal,partIn.getInvMin());
        partOut.setInvMin(expVal);
        assertEquals(expVal,partOut.getInvMin());
    }
    @Test
    public void maxInv() {
        int expValMax = 5;
        partIn.setInvMax(expValMax);
        assertEquals(expValMax,partIn.getInvMax());
        partOut.setInvMax(expValMax);
        assertEquals(expValMax,partOut.getInvMax());
    }
}